 ...
 * @param {Advantage} merit Vantagem a ser renderizada.
**/
function createMeritBlock(merit) {
    ...
    let meritNameIn = document.createElement('input');
    meritNameIn.value = merit.name;
    meritNameIn.placeholder = 'Digite nome da Vantagem...';
    meritNameIn.addEventListener('blur', (event) => changeMeritName(merit.id, event.target.value));
    ...
    delBtn.innerHTML = 'X';
    delBtn.addEventListener('click', () => remoteMerit(merit.id));
    ...
    // Append.    
    meritElement.appendChild(meritNameIn);
